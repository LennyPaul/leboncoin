...
use App\Mail\AnnonceConfDelete;
...
class AnnonceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            try {
                ...
                return redirect()->back()->with('error', 'Une erreur s\'est produite lors de l\'envoi du mail.');
            }
            $annonce = new Annonce();
    ...
    public function delete($token)
    {
        try {
            $annonce = Annonce::where('token', $token)->firstOrFail();
            Mail::to($annonce->email)->send(new AnnonceConfDelete());
            $annonce->delete();
